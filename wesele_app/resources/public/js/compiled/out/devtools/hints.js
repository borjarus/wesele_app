...
var reader = (function (){var or__33334__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__33334__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__33334__auto__)){
return or__33334__auto__;
} else {
return (128);
...
var map__68793 = top_item;
var map__68793__$1 = ((((!((map__68793 == null)))?((((map__68793.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__68793.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__68793):map__68793);
var file = cljs.core.get.call(null,map__68793__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__68793__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__68793__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e68792){var _e = e68792;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___68795 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___68795)){
var seen_errors_68796 = temp__4655__auto___68795;
if(cljs.core.truth_(seen_errors_68796.has(self))){
} else {
seen_errors_68796.add(self);

var temp__4657__auto___68797 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___68797)){
var sense_68798 = temp__4657__auto___68797;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),cljs.core.str.cljs$core$IFn$_invoke$arity$1(", a sanity hint:\n"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_68798)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1510317648905