...
var args53635 = [];
var len__34925__auto___53641 = arguments.length;
var i__34926__auto___53642 = (0);
while(true){
if((i__34926__auto___53642 < len__34925__auto___53641)){
args53635.push((arguments[i__34926__auto___53642]));

var G__53643 = (i__34926__auto___53642 + (1));
i__34926__auto___53642 = G__53643;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args53635.length)].join('')));
...
if(typeof devtools.toolbox.t_devtools$toolbox53638 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox53638 = (function (obj,header,style,tag,meta53639){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox53638.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_53640,meta53639__$1){
var self__ = this;
var _53640__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox53638(self__.obj,self__.header,self__.style,self__.tag,meta53639__$1));
});

devtools.toolbox.t_devtools$toolbox53638.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_53640){
var self__ = this;
var _53640__$1 = this;
return self__.meta53639;
});

devtools.toolbox.t_devtools$toolbox53638.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL;

devtools.toolbox.t_devtools$toolbox53638.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox53638.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox53638.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox53638.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta53639","meta53639",2017903674,null)], null);
});

devtools.toolbox.t_devtools$toolbox53638.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox53638.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox53638";

devtools.toolbox.t_devtools$toolbox53638.cljs$lang$ctorPrWriter = (function (this__34423__auto__,writer__34424__auto__,opt__34425__auto__){
return cljs.core._write.call(null,writer__34424__auto__,"devtools.toolbox/t_devtools$toolbox53638");
});

devtools.toolbox.__GT_t_devtools$toolbox53638 = (function devtools$toolbox$__GT_t_devtools$toolbox53638(obj__$1,header__$1,style__$1,tag__$1,meta53639){
return (new devtools.toolbox.t_devtools$toolbox53638(obj__$1,header__$1,style__$1,tag__$1,meta53639));
});

}

return (new devtools.toolbox.t_devtools$toolbox53638(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1526470225467