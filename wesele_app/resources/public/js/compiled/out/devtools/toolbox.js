...
var args21141 = [];
var len__7878__auto___21147 = arguments.length;
var i__7879__auto___21148 = (0);
while(true){
if((i__7879__auto___21148 < len__7878__auto___21147)){
args21141.push((arguments[i__7879__auto___21148]));

var G__21149 = (i__7879__auto___21148 + (1));
i__7879__auto___21148 = G__21149;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args21141.length)].join('')));
...
if(typeof devtools.toolbox.t_devtools$toolbox21144 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox21144 = (function (obj,header,style,tag,meta21145){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox21144.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_21146,meta21145__$1){
var self__ = this;
var _21146__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox21144(self__.obj,self__.header,self__.style,self__.tag,meta21145__$1));
});

devtools.toolbox.t_devtools$toolbox21144.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_21146){
var self__ = this;
var _21146__$1 = this;
return self__.meta21145;
});

devtools.toolbox.t_devtools$toolbox21144.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL;

devtools.toolbox.t_devtools$toolbox21144.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox21144.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox21144.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox21144.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta21145","meta21145",-1667049649,null)], null);
});

devtools.toolbox.t_devtools$toolbox21144.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox21144.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox21144";

devtools.toolbox.t_devtools$toolbox21144.cljs$lang$ctorPrWriter = (function (this__7376__auto__,writer__7377__auto__,opt__7378__auto__){
return cljs.core._write.call(null,writer__7377__auto__,"devtools.toolbox/t_devtools$toolbox21144");
});

devtools.toolbox.__GT_t_devtools$toolbox21144 = (function devtools$toolbox$__GT_t_devtools$toolbox21144(obj__$1,header__$1,style__$1,tag__$1,meta21145){
return (new devtools.toolbox.t_devtools$toolbox21144(obj__$1,header__$1,style__$1,tag__$1,meta21145));
});

}

return (new devtools.toolbox.t_devtools$toolbox21144(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1513114979816