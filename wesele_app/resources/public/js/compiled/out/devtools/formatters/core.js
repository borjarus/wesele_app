...
var and__33800__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__33800__auto__){
var or__33812__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e53606){var e__50771__auto__ = e53606;
return false;
...
}catch (e53608){var e__50771__auto__ = e53608;
return false;
...
}catch (e53614){var e__50771__auto__ = e53614;
return false;
...
}catch (e53616){var e__50771__auto__ = e53616;
return false;
...
}catch (e53622){var e__50771__auto__ = e53622;
return false;
}})())){
...
}catch (e53624){var e__50771__auto__ = e53624;
return false;
}})())){
...
var _STAR_current_state_STAR_53627 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = (function (){var or__33812__auto__ = config;
if(cljs.core.truth_(or__33812__auto__)){
return or__33812__auto__;
} else {
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_53627;
}});
});
...
while (G__53631__i < G__53631__a.length) {G__53631__a[G__53631__i] = arguments[G__53631__i + 0]; ++G__53631__i;}
  args = new cljs.core.IndexedSeq(G__53631__a,0);
} 
...
var pre_handler = (function (){var or__33812__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__33812__auto__)){
return or__33812__auto__;
} else {
...
var post_handler = (function (){var or__33812__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__33812__auto__)){
return or__33812__auto__;
} else {
return cljs.core.identity;
...
//# sourceMappingURL=core.js.map?rel=1526470224989