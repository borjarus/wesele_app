...
var len__7878__auto___20662 = arguments.length;
var i__7879__auto___20663 = (0);
while(true){
if((i__7879__auto___20663 < len__7878__auto___20662)){
args__7885__auto__.push((arguments[i__7879__auto___20663]));

var G__20664 = (i__7879__auto___20663 + (1));
i__7879__auto___20663 = G__20664;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7886__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq20660){
var G__20661 = cljs.core.first.call(null,seq20660);
var seq20660__$1 = cljs.core.next.call(null,seq20660);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__20661,seq20660__$1);
});
...
return (p1__20665_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1513114975009