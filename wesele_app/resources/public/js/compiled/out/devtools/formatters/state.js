...
var len__34925__auto___53156 = arguments.length;
var i__34926__auto___53157 = (0);
while(true){
if((i__34926__auto___53157 < len__34925__auto___53156)){
args__34932__auto__.push((arguments[i__34926__auto___53157]));

var G__53158 = (i__34926__auto___53157 + (1));
i__34926__auto___53157 = G__53158;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__34933__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq53154){
var G__53155 = cljs.core.first.call(null,seq53154);
var seq53154__$1 = cljs.core.next.call(null,seq53154);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__53155,seq53154__$1);
});
...
return (p1__53159_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1526470218233