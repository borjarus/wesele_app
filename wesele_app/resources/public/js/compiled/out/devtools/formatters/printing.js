...
var len__44607__auto___71922 = arguments.length;
var i__44608__auto___71923 = (0);
while(true){
if((i__44608__auto___71923 < len__44607__auto___71922)){
args__44614__auto__.push((arguments[i__44608__auto___71923]));

var G__71924 = (i__44608__auto___71923 + (1));
i__44608__auto___71923 = G__71924;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__44615__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq71919){
var G__71920 = cljs.core.first.call(null,seq71919);
var seq71919__$1 = cljs.core.next.call(null,seq71919);
var G__71921 = cljs.core.first.call(null,seq71919__$1);
var seq71919__$2 = cljs.core.next.call(null,seq71919__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__71920,G__71921,seq71919__$2);
});
...
if(cljs.core.truth_((function (){var or__43494__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__44105__auto__,writer__44106__auto__,opt__44107__auto__){
return cljs.core._write.call(null,writer__44106__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__43482__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__43482__auto__){
var or__43494__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__43494__auto__)){
return or__43494__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__71925_SHARP_){
return !((cljs.core.meta.call(null,p1__71925_SHARP_) == null));
})))){
...
var map__71934 = opts;
var map__71934__$1 = ((((!((map__71934 == null)))?((((map__71934.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__71934.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__71934):map__71934);
var markup_db = cljs.core.get.call(null,map__71934__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__43494__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e71938){var e__69479__auto__ = e71938;
return false;
}})();
if(cljs.core.truth_(or__43494__auto__)){
return or__43494__auto__;
...
}catch (e71940){var e__69479__auto__ = e71940;
return false;
}}
})())){
...
var _STAR_current_state_STAR_71945 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__71946 = opts;
var map__71946__$1 = ((((!((map__71946 == null)))?((((map__71946.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__71946.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__71946):map__71946);
var markup_db = cljs.core.get.call(null,map__71946__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_71945;
}});
...
;
var temp__4655__auto___71951 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___71951)){
var managed_print_level_71952 = temp__4655__auto___71951;
var _STAR_print_level_STAR_71950_71953 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_71952;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_71950_71953,managed_print_level_71952,temp__4655__auto___71951,writer,opts,job_fn){
return (function (p1__71948_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__71948_SHARP_,null);
});})(_STAR_print_level_STAR_71950_71953,managed_print_level_71952,temp__4655__auto___71951,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_71950_71953;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1494353265645