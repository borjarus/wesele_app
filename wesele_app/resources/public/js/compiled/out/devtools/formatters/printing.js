...
var len__7878__auto___20671 = arguments.length;
var i__7879__auto___20672 = (0);
while(true){
if((i__7879__auto___20672 < len__7878__auto___20671)){
args__7885__auto__.push((arguments[i__7879__auto___20672]));

var G__20673 = (i__7879__auto___20672 + (1));
i__7879__auto___20672 = G__20673;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__7886__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq20668){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__20669,G__20670,seq20668__$2);
});
...
if(cljs.core.truth_((function (){var or__6765__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__7376__auto__,writer__7377__auto__,opt__7378__auto__){
return cljs.core._write.call(null,writer__7377__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__6753__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__6753__auto__){
var or__6765__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__6765__auto__)){
return or__6765__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__20674_SHARP_){
return !((cljs.core.meta.call(null,p1__20674_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__20683__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__6765__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e20687){var e__18187__auto__ = e20687;
return false;
}})();
if(cljs.core.truth_(or__6765__auto__)){
return or__6765__auto__;
...
}catch (e20689){var e__18187__auto__ = e20689;
return false;
}}
})())){
...
var _STAR_current_state_STAR_20694 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__20695 = opts;
...
var markup_db = cljs.core.get.call(null,map__20695__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_20694;
}});
...
;
var temp__4655__auto___20700 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___20700)){
var managed_print_level_20701 = temp__4655__auto___20700;
var _STAR_print_level_STAR_20699_20702 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_20701;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_20699_20702,managed_print_level_20701,temp__4655__auto___20700,writer,opts,job_fn){
return (function (p1__20697_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__20697_SHARP_,null);
});})(_STAR_print_level_STAR_20699_20702,managed_print_level_20701,temp__4655__auto___20700,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_20699_20702;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1513114975554