...
var len__34925__auto___53165 = arguments.length;
var i__34926__auto___53166 = (0);
while(true){
if((i__34926__auto___53166 < len__34925__auto___53165)){
args__34932__auto__.push((arguments[i__34926__auto___53166]));

var G__53167 = (i__34926__auto___53166 + (1));
i__34926__auto___53166 = G__53167;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__34933__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq53162){
var G__53163 = cljs.core.first.call(null,seq53162);
var seq53162__$1 = cljs.core.next.call(null,seq53162);
var G__53164 = cljs.core.first.call(null,seq53162__$1);
var seq53162__$2 = cljs.core.next.call(null,seq53162__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__53163,G__53164,seq53162__$2);
});
...
if(cljs.core.truth_((function (){var or__33812__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__34423__auto__,writer__34424__auto__,opt__34425__auto__){
return cljs.core._write.call(null,writer__34424__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__33800__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__33800__auto__){
var or__33812__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__33812__auto__)){
return or__33812__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__53168_SHARP_){
return !((cljs.core.meta.call(null,p1__53168_SHARP_) == null));
})))){
...
var map__53177 = opts;
var map__53177__$1 = ((((!((map__53177 == null)))?((((map__53177.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53177.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__53177):map__53177);
var markup_db = cljs.core.get.call(null,map__53177__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__33812__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e53181){var e__50771__auto__ = e53181;
return false;
}})();
if(cljs.core.truth_(or__33812__auto__)){
return or__33812__auto__;
...
}catch (e53183){var e__50771__auto__ = e53183;
return false;
}}
})())){
...
var _STAR_current_state_STAR_53188 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__53189 = opts;
...
var markup_db = cljs.core.get.call(null,map__53189__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_53188;
}});
...
;
var temp__4655__auto___53194 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___53194)){
var managed_print_level_53195 = temp__4655__auto___53194;
var _STAR_print_level_STAR_53193_53196 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_53195;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_53193_53196,managed_print_level_53195,temp__4655__auto___53194,writer,opts,job_fn){
return (function (p1__53191_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__53191_SHARP_,null);
});})(_STAR_print_level_STAR_53193_53196,managed_print_level_53195,temp__4655__auto___53194,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_53193_53196;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1526470219182