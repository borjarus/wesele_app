...
var len__34447__auto___68306 = arguments.length;
var i__34448__auto___68307 = (0);
while(true){
if((i__34448__auto___68307 < len__34447__auto___68306)){
args__34454__auto__.push((arguments[i__34448__auto___68307]));

var G__68308 = (i__34448__auto___68307 + (1));
i__34448__auto___68307 = G__68308;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__34455__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq68303){
var G__68304 = cljs.core.first.call(null,seq68303);
var seq68303__$1 = cljs.core.next.call(null,seq68303);
var G__68305 = cljs.core.first.call(null,seq68303__$1);
var seq68303__$2 = cljs.core.next.call(null,seq68303__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__68304,G__68305,seq68303__$2);
});
...
if(cljs.core.truth_((function (){var or__33334__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__33945__auto__,writer__33946__auto__,opt__33947__auto__){
return cljs.core._write.call(null,writer__33946__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__33322__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__33322__auto__){
var or__33334__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__33334__auto__)){
return or__33334__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__68309_SHARP_){
return !((cljs.core.meta.call(null,p1__68309_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__68318__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__33334__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e68322){var e__49751__auto__ = e68322;
return false;
}})();
if(cljs.core.truth_(or__33334__auto__)){
return or__33334__auto__;
...
}catch (e68324){var e__49751__auto__ = e68324;
return false;
}}
})())){
...
var _STAR_current_state_STAR_68329 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__68330 = opts;
var map__68330__$1 = ((((!((map__68330 == null)))?((((map__68330.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__68330.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__68330):map__68330);
var markup_db = cljs.core.get.call(null,map__68330__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_68329;
}});
...
;
var temp__4655__auto___68335 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___68335)){
var managed_print_level_68336 = temp__4655__auto___68335;
var _STAR_print_level_STAR_68334_68337 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_68336;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_68334_68337,managed_print_level_68336,temp__4655__auto___68335,writer,opts,job_fn){
return (function (p1__68332_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__68332_SHARP_,null);
});})(_STAR_print_level_STAR_68334_68337,managed_print_level_68336,temp__4655__auto___68335,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_68334_68337;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1510317624883