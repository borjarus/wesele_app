...
var G__53124 = devtools.prefs.pref.call(null,v);
v = G__53124;
continue;
} else {
return v;
...
var and__33800__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__33800__auto__){
var and__33800__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__33812__auto__ = (function (){try{if(!((value == null))){
...
}catch (e53137){var e__50771__auto__ = e53137;
return false;
}})();
if(cljs.core.truth_(or__33812__auto__)){
return or__33812__auto__;
} else {
var or__33812__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e53141){var e__50771__auto__ = e53141;
return false;
}})();
...
}catch (e53143){var e__50771__auto__ = e53143;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__33800__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__33800__auto__)){
var and__33800__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__33800__auto____$1){
...
var and__33800__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__33800__auto__)){
...
var or__33812__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__33812__auto__)){
return or__33812__auto__;
} else {
...
var and__33800__auto__ = (function (){var or__33812__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__33812__auto__)){
return or__33812__auto__;
} else {
...
var vec__53148 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__53148,(0),null);
var name = cljs.core.nth.call(null,vec__53148,(1),null);
...
var and__33800__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__33800__auto__)){
...
var or__33812__auto__ = typeof value === 'string';
if(or__33812__auto__){
return or__33812__auto__;
} else {
var or__33812__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__53151_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__53151_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1526470217744