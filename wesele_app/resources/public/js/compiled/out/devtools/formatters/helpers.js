...
var G__20630 = devtools.prefs.pref.call(null,v);
v = G__20630;
continue;
} else {
return v;
...
var and__6753__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__6753__auto__){
var and__6753__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__6765__auto__ = (function (){try{if(!((value == null))){
...
}catch (e20643){var e__18187__auto__ = e20643;
return false;
}})();
if(cljs.core.truth_(or__6765__auto__)){
return or__6765__auto__;
} else {
var or__6765__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e20647){var e__18187__auto__ = e20647;
return false;
}})();
...
}catch (e20649){var e__18187__auto__ = e20649;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__6753__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__6753__auto__)){
var and__6753__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__6753__auto____$1){
...
var and__6753__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__6753__auto__)){
...
var or__6765__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__6765__auto__)){
return or__6765__auto__;
} else {
...
var and__6753__auto__ = (function (){var or__6765__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__6765__auto__)){
return or__6765__auto__;
} else {
...
var vec__20654 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__20654,(0),null);
var name = cljs.core.nth.call(null,vec__20654,(1),null);
...
var and__6753__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__6753__auto__)){
...
var or__6765__auto__ = typeof value === 'string';
if(or__6765__auto__){
return or__6765__auto__;
} else {
var or__6765__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__20657_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__20657_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1513114974666