...
var G__71881 = devtools.prefs.pref.call(null,v);
v = G__71881;
continue;
} else {
return v;
...
var and__43482__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__43482__auto__){
var and__43482__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__43494__auto__ = (function (){try{if(!((value == null))){
...
}catch (e71894){var e__69479__auto__ = e71894;
return false;
}})();
if(cljs.core.truth_(or__43494__auto__)){
return or__43494__auto__;
} else {
var or__43494__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e71898){var e__69479__auto__ = e71898;
return false;
}})();
...
}catch (e71900){var e__69479__auto__ = e71900;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__43482__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__43482__auto__)){
var and__43482__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__43482__auto____$1){
...
var and__43482__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__43482__auto__)){
...
var or__43494__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__43494__auto__)){
return or__43494__auto__;
} else {
...
var and__43482__auto__ = (function (){var or__43494__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__43494__auto__)){
return or__43494__auto__;
} else {
...
var vec__71905 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__71905,(0),null);
var name = cljs.core.nth.call(null,vec__71905,(1),null);
...
var and__43482__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__43482__auto__)){
...
var or__43494__auto__ = typeof value === 'string';
if(or__43494__auto__){
return or__43494__auto__;
} else {
var or__43494__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__71908_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__71908_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1494353264325