...
var G__68265 = devtools.prefs.pref.call(null,v);
v = G__68265;
continue;
} else {
return v;
...
var and__33322__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__33322__auto__){
var and__33322__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__33334__auto__ = (function (){try{if(!((value == null))){
...
}catch (e68278){var e__49751__auto__ = e68278;
return false;
}})();
if(cljs.core.truth_(or__33334__auto__)){
return or__33334__auto__;
} else {
var or__33334__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e68282){var e__49751__auto__ = e68282;
return false;
}})();
...
}catch (e68284){var e__49751__auto__ = e68284;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__33322__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__33322__auto__)){
var and__33322__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__33322__auto____$1){
...
var and__33322__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__33322__auto__)){
...
var or__33334__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__33334__auto__)){
return or__33334__auto__;
} else {
...
var and__33322__auto__ = (function (){var or__33334__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__33334__auto__)){
return or__33334__auto__;
} else {
...
var vec__68289 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__68289,(0),null);
var name = cljs.core.nth.call(null,vec__68289,(1),null);
...
var and__33322__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__33322__auto__)){
...
var or__33334__auto__ = typeof value === 'string';
if(or__33334__auto__){
return or__33334__auto__;
} else {
var or__33334__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__68292_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__68292_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1510317619435