...
var col = cljs.core.map.call(null,(function (p1__37714_SHARP_){
return clojure.string.split.call(null,p1__37714_SHARP_,/\s+/);
}),cljs.core.map.call(null,(function (p1__37715_SHARP_){
return clojure.string.trim.call(null,p1__37715_SHARP_);
}),clojure.string.split.call(null,n,/\|/)));
return cljs.core.map.call(null,((function (col){
return (function (p1__37716_SHARP_){
return cljs.core.apply.call(null,cljs.core.str,p1__37716_SHARP_);
});})(col))
,cljs.core.map.call(null,cljs.core.flatten,cljs.core.map.call(null,((function (col){
return (function (c){
return cljs.core.map.call(null,((function (col){
return (function (p1__37717_SHARP_){
return cljs.core.take.call(null,(2),p1__37717_SHARP_);
});})(col))
,c);
});})(col))
,col)));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.menu-icon","span.menu-icon",-986462898),(function (){var pred__37721 = cljs.core._EQ_;
var expr__37722 = cljs.core.deref.call(null,active_link);
if(cljs.core.truth_(pred__37721.call(null,new cljs.core.Keyword(null,"home-page","home-page",1804156194),expr__37722))){
return "a";
} else {
if(cljs.core.truth_(pred__37721.call(null,new cljs.core.Keyword(null,"rsvp-page","rsvp-page",2134532812),expr__37722))){
return "d";
} else {
if(cljs.core.truth_(pred__37721.call(null,new cljs.core.Keyword(null,"news-page","news-page",2102188526),expr__37722))){
return "d";
} else {
if(cljs.core.truth_(pred__37721.call(null,new cljs.core.Keyword(null,"church-page","church-page",1788377738),expr__37722))){
return "b";
} else {
if(cljs.core.truth_(pred__37721.call(null,new cljs.core.Keyword(null,"wedding-hall-page","wedding-hall-page",1494295634),expr__37722))){
return "c";
} else {
if(cljs.core.truth_(pred__37721.call(null,new cljs.core.Keyword(null,"gallery-page","gallery-page",-1458032316),expr__37722))){
return "e";
} else {
if(cljs.core.truth_(pred__37721.call(null,new cljs.core.Keyword(null,"gifts-page","gifts-page",-826646564),expr__37722))){
return "f";
} else {
if(cljs.core.truth_(pred__37721.call(null,new cljs.core.Keyword(null,"accomodations-page","accomodations-page",-920276277),expr__37722))){
return "g";
} else {
return "a";
}
...
return wesele_app.views.navbar.handle_login.call(null,p1__37724_SHARP_,p1__37724_SHARP_.target.value,document.getElementById("password").value);
});})(menu,user))
...
//# sourceMappingURL=navbar.js.map?rel=1526470049640