...
goog.require('wesele_app.views.accomodations');
if(typeof wesele_app.views.panels !== 'undefined'){
} else {
wesele_app.views.panels = (function (){var method_table__34745__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"wesele-app.views","panels"),cljs.core.identity,new cljs.core.Keyword(null,"default","default",-1987822328),hierarchy__34749__auto__,method_table__34745__auto__,prefer_table__34746__auto__,method_cache__34747__auto__,cached_hierarchy__34748__auto__));
})();
}
...
cljs.core._add_method.call(null,wesele_app.views.panels,new cljs.core.Keyword(null,"accomodations-page","accomodations-page",-920276277),(function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [wesele_app.views.accomodations.accomodations_page], null);
}));
...
//# sourceMappingURL=views.js.map?rel=1526470095030