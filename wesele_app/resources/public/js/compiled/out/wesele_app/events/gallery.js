...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"gallery","gallery",1782868083),(function (db,p__17706){
var vec__17707 = p__17706;
var _ = cljs.core.nth.call(null,vec__17707,(0),null);
var gallery_opts = cljs.core.nth.call(null,vec__17707,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword(null,"gallery","gallery",1782868083),gallery_opts);
}));
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword(null,"request-gallery","request-gallery",1471550078),(function (p__17710,p__17711){
...
var db = cljs.core.get.call(null,map__17712__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__17713 = p__17711;
var _ = cljs.core.nth.call(null,vec__17713,(0),null);
var url = cljs.core.nth.call(null,vec__17713,(1),null);
...
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword(null,"process-response","process-response",-26308683),(function (p__17718,p__17719){
...
var db = cljs.core.get.call(null,map__17720__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__17721 = p__17719;
var _ = cljs.core.nth.call(null,vec__17721,(0),null);
var response = cljs.core.nth.call(null,vec__17721,(1),null);
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),(function (){var out = cljs.core.map.call(null,((function (map__17720,map__17720__$1,db,vec__17721,_,response){
return (function (p1__17717_SHARP_){
return wesele_app.events.gallery.single_image_obj.call(null,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"path_src","path_src",1161642275).cljs$core$IFn$_invoke$arity$1(p1__17717_SHARP_)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"filename","filename",-1428840783).cljs$core$IFn$_invoke$arity$1(p1__17717_SHARP_))].join(''),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"path_src","path_src",1161642275).cljs$core$IFn$_invoke$arity$1(p1__17717_SHARP_)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"filename","filename",-1428840783).cljs$core$IFn$_invoke$arity$1(p1__17717_SHARP_))].join(''),"Title","Bla Bla Bla");
});})(map__17720,map__17720__$1,db,vec__17721,_,response))
,response);
...
//# sourceMappingURL=gallery.js.map?rel=1513114954364