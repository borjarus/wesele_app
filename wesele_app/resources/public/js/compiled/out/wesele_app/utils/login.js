...
var v = (function (){var pred__17343 = cljs.core._EQ_;
var expr__17344 = type;
if(cljs.core.truth_(pred__17343.call(null,new cljs.core.Keyword(null,"time","time",1385887882),expr__17344))){
return s.get("login-exp");
} else {
if(cljs.core.truth_(pred__17343.call(null,new cljs.core.Keyword(null,"user","user",1532431356),expr__17344))){
return s.get("login");
} else {
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("No matching clause: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__17344)].join('')));
}
}
})();
if(!((v == null))){
...
var user_17346 = wesele_app.utils.login.get_login_type.call(null,new cljs.core.Keyword(null,"user","user",1532431356));
var clt_17347 = wesele_app.utils.login.check_login_time.call(null);
new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [user_17346,clt_17347], null);

//# sourceMappingURL=login.js.map?rel=1513114952145