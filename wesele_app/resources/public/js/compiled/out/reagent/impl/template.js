...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__33945__auto__,writer__33946__auto__,opt__33947__auto__){
return cljs.core._write.call(null,writer__33946__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__54243 = o;
(G__54243[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__54244__delegate = function (args){
...
while (G__54245__i < G__54245__a.length) {G__54245__a[G__54245__i] = arguments[G__54245__i + 0]; ++G__54245__i;}
  args = new cljs.core.IndexedSeq(G__54245__a,0);
} 
return G__54244__delegate.call(this,args);};
G__54244.cljs$lang$maxFixedArity = 0;
G__54244.cljs$lang$applyTo = (function (arglist__54246){
var args = cljs.core.seq(arglist__54246);
return G__54244__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__33322__auto__ = !((jsprops == null));
if(and__33322__auto__){
var and__33322__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__54252 = jsprops;
(G__54252["defaultValue"] = value);

(G__54252["onChange"] = ((function (G__54252,v,value,on_change){
return (function (p1__54249_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__54249_SHARP_);
});})(G__54252,v,value,on_change))
);

(G__54252["ref"] = ((function (G__54252,v,value,on_change){
return (function (p1__54250_SHARP_){
return (this$["cljsInputElement"] = p1__54250_SHARP_);
});})(G__54252,v,value,on_change))
);
...
var vec__54259 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__54259,(0),null);
var id = cljs.core.nth.call(null,vec__54259,(1),null);
var class$ = cljs.core.nth.call(null,vec__54259,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___54264 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___54264 == null)){
} else {
var key_54265 = temp__4661__auto___54264;
(jsprops["key"] = key_54265);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__54267 = (new reagent.impl.template.NativeWrapper());
(G__54267["name"] = c);
...
var len__34447__auto___54273 = arguments.length;
var i__34448__auto___54274 = (0);
while(true){
if((i__34448__auto___54274 < len__34447__auto___54273)){
args__34454__auto__.push((arguments[i__34448__auto___54274]));

var G__54275 = (i__34448__auto___54274 + (1));
i__34448__auto___54274 = G__54275;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__34455__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq54271){
var G__54272 = cljs.core.first.call(null,seq54271);
var seq54271__$1 = cljs.core.next.call(null,seq54271);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__54272,seq54271__$1);
});
...
break;
default:
var G__54279 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__54279;
continue;
...
var n__34257__auto___54282 = a.length;
var i_54283 = (0);
while(true){
if((i_54283 < n__34257__auto___54282)){
(a[i_54283] = reagent.impl.template.as_element.call(null,(a[i_54283])));

var G__54284 = (i_54283 + (1));
i_54283 = G__54284;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__34257__auto___54285 = a.length;
var i_54286 = (0);
while(true){
if((i_54286 < n__34257__auto___54285)){
var val_54287 = (a[i_54286]);
if((cljs.core.vector_QMARK_.call(null,val_54287)) && ((reagent.impl.template.key_from_vec.call(null,val_54287) == null))){
(o["no-key"] = true);
} else {
}

(a[i_54286] = reagent.impl.template.as_element.call(null,val_54287));

var G__54288 = (i_54286 + (1));
i_54286 = G__54288;
continue;
} else {
}
...
var ctx = ({});
var vec__54292 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__54292,(0),null);
var derefed = cljs.core.nth.call(null,vec__54292,(1),null);
...
var G__54296 = (cljs.core.count.call(null,argv) - first_child);
switch (G__54296) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__54296){
...
//# sourceMappingURL=template.js.map?rel=1510317288632