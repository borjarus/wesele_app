...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__44105__auto__,writer__44106__auto__,opt__44107__auto__){
return cljs.core._write.call(null,writer__44106__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__57875 = o;
(G__57875[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__57876__delegate = function (args){
...
while (G__57877__i < G__57877__a.length) {G__57877__a[G__57877__i] = arguments[G__57877__i + 0]; ++G__57877__i;}
  args = new cljs.core.IndexedSeq(G__57877__a,0);
} 
return G__57876__delegate.call(this,args);};
G__57876.cljs$lang$maxFixedArity = 0;
G__57876.cljs$lang$applyTo = (function (arglist__57878){
var args = cljs.core.seq(arglist__57878);
return G__57876__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__43482__auto__ = !((jsprops == null));
if(and__43482__auto__){
var and__43482__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__57884 = jsprops;
(G__57884["defaultValue"] = value);

(G__57884["onChange"] = ((function (G__57884,v,value,on_change){
return (function (p1__57881_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__57881_SHARP_);
});})(G__57884,v,value,on_change))
);

(G__57884["ref"] = ((function (G__57884,v,value,on_change){
return (function (p1__57882_SHARP_){
return (this$["cljsInputElement"] = p1__57882_SHARP_);
});})(G__57884,v,value,on_change))
);
...
var vec__57891 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__57891,(0),null);
var id = cljs.core.nth.call(null,vec__57891,(1),null);
var class$ = cljs.core.nth.call(null,vec__57891,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___57896 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___57896 == null)){
} else {
var key_57897 = temp__4661__auto___57896;
(jsprops["key"] = key_57897);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__57899 = (new reagent.impl.template.NativeWrapper());
(G__57899["name"] = c);
...
var len__44607__auto___57905 = arguments.length;
var i__44608__auto___57906 = (0);
while(true){
if((i__44608__auto___57906 < len__44607__auto___57905)){
args__44614__auto__.push((arguments[i__44608__auto___57906]));

var G__57907 = (i__44608__auto___57906 + (1));
i__44608__auto___57906 = G__57907;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__44615__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq57903){
var G__57904 = cljs.core.first.call(null,seq57903);
var seq57903__$1 = cljs.core.next.call(null,seq57903);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__57904,seq57903__$1);
});
...
break;
default:
var G__57911 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__57911;
continue;
...
var n__44417__auto___57914 = a.length;
var i_57915 = (0);
while(true){
if((i_57915 < n__44417__auto___57914)){
(a[i_57915] = reagent.impl.template.as_element.call(null,(a[i_57915])));

var G__57916 = (i_57915 + (1));
i_57915 = G__57916;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__44417__auto___57917 = a.length;
var i_57918 = (0);
while(true){
if((i_57918 < n__44417__auto___57917)){
var val_57919 = (a[i_57918]);
if((cljs.core.vector_QMARK_.call(null,val_57919)) && ((reagent.impl.template.key_from_vec.call(null,val_57919) == null))){
(o["no-key"] = true);
} else {
}

(a[i_57918] = reagent.impl.template.as_element.call(null,val_57919));

var G__57920 = (i_57918 + (1));
i_57918 = G__57920;
continue;
} else {
}
...
var ctx = ({});
var vec__57924 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__57924,(0),null);
var derefed = cljs.core.nth.call(null,vec__57924,(1),null);
...
var G__57928 = (cljs.core.count.call(null,argv) - first_child);
switch (G__57928) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__57928){
...
//# sourceMappingURL=template.js.map?rel=1494353122707