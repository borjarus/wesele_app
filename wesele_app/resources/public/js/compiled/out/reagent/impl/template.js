...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__7376__auto__,writer__7377__auto__,opt__7378__auto__){
return cljs.core._write.call(null,writer__7377__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__9576 = o;
(G__9576[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__6753__auto__ = !((jsprops == null));
if(and__6753__auto__){
var and__6753__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__9585 = jsprops;
(G__9585["defaultValue"] = value);

(G__9585["onChange"] = ((function (G__9585,v,value,on_change){
return (function (p1__9582_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__9582_SHARP_);
});})(G__9585,v,value,on_change))
);

(G__9585["ref"] = ((function (G__9585,v,value,on_change){
return (function (p1__9583_SHARP_){
return (this$["cljsInputElement"] = p1__9583_SHARP_);
});})(G__9585,v,value,on_change))
);
...
var vec__9592 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__9592,(0),null);
var id = cljs.core.nth.call(null,vec__9592,(1),null);
var class$ = cljs.core.nth.call(null,vec__9592,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___9597 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___9597 == null)){
} else {
var key_9598 = temp__4661__auto___9597;
(jsprops["key"] = key_9598);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__9600 = (new reagent.impl.template.NativeWrapper());
(G__9600["name"] = c);
...
var len__7878__auto___9606 = arguments.length;
var i__7879__auto___9607 = (0);
while(true){
if((i__7879__auto___9607 < len__7878__auto___9606)){
args__7885__auto__.push((arguments[i__7879__auto___9607]));

var G__9608 = (i__7879__auto___9607 + (1));
i__7879__auto___9607 = G__9608;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7886__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq9604){
var G__9605 = cljs.core.first.call(null,seq9604);
var seq9604__$1 = cljs.core.next.call(null,seq9604);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__9605,seq9604__$1);
});
...
break;
default:
var G__9612 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__9612;
continue;
...
var n__7688__auto___9615 = a.length;
var i_9616 = (0);
while(true){
if((i_9616 < n__7688__auto___9615)){
(a[i_9616] = reagent.impl.template.as_element.call(null,(a[i_9616])));
...
var a = cljs.core.into_array.call(null,s);
var n__7688__auto___9618 = a.length;
var i_9619 = (0);
while(true){
if((i_9619 < n__7688__auto___9618)){
var val_9620 = (a[i_9619]);
if((cljs.core.vector_QMARK_.call(null,val_9620)) && ((reagent.impl.template.key_from_vec.call(null,val_9620) == null))){
(o["no-key"] = true);
} else {
}

(a[i_9619] = reagent.impl.template.as_element.call(null,val_9620));

var G__9621 = (i_9619 + (1));
i_9619 = G__9621;
continue;
} else {
}
...
var ctx = ({});
var vec__9625 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__9625,(0),null);
var derefed = cljs.core.nth.call(null,vec__9625,(1),null);
...
var G__9629 = (cljs.core.count.call(null,argv) - first_child);
switch (G__9629) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__9629){
...
//# sourceMappingURL=template.js.map?rel=1513114913185