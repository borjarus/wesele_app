...
goog.addDependency("../wesele_app/views/accomodations.js", ['wesele_app.views.accomodations'], ['wesele_app.views.navbar', 'reagent.core', 'cljs.core', 're_frame.core']);
...
goog.addDependency("../wesele_app/views/upload_component.js", ['wesele_app.views.upload_component'], ['goog.dom', 'reagent.core', 'cljs.core', 'goog.crypt.base64', 'cljs_http.client', 'cljs.core.async', 're_frame.core']);
goog.addDependency("../wesele_app/views/index.js", ['wesele_app.views.index'], ['goog.dom', 'wesele_app.events.index', 'wesele_app.views.navbar', 'reagent.core', 'cljs.core', 'wesele_app.views.upload_component', 're_frame.core']);
...
goog.addDependency("../wesele_app/views/gifts.js", ['wesele_app.views.gifts'], ['wesele_app.views.navbar', 'reagent.core', 'cljs.core', 're_frame.core']);
goog.addDependency("../wesele_app/views.js", ['wesele_app.views'], ['wesele_app.views.news', 'wesele_app.views.church', 'cljs.core', 'wesele_app.views.index', 'wesele_app.views.login', 'wesele_app.views.wedding_hall', 'wesele_app.views.gallery', 'wesele_app.views.rsvp', 'wesele_app.views.gifts', 'wesele_app.views.accomodations', 're_frame.core']);
...
goog.addDependency("../64C8545.js", ['figwheel.connect.dev'], ['cljs.core', 'wesele_app.core', 'figwheel.client', 'figwheel.client.utils']);
