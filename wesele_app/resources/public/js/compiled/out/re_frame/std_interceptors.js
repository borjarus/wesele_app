...
var vec__10234_10237 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_10238 = cljs.core.nth.call(null,vec__10234_10237,(0),null);
var only_after_10239 = cljs.core.nth.call(null,vec__10234_10237,(1),null);
var db_changed_QMARK__10240 = (!((only_before_10238 == null))) || (!((only_after_10239 == null)));
if(db_changed_QMARK__10240){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_10238);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_10239);
...
var map__10247 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__10247__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__10247__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__10255 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__10255__$1;
var event = cljs.core.get.call(null,map__10255__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__7878__auto___10258 = arguments.length;
var i__7879__auto___10259 = (0);
while(true){
if((i__7879__auto___10259 < len__7878__auto___10258)){
args__7885__auto__.push((arguments[i__7879__auto___10259]));

var G__10260 = (i__7879__auto___10259 + (1));
i__7879__auto___10259 = G__10260;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__7886__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq10257){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq10257));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__6765__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__7885__auto__ = [];
var len__7878__auto___10266 = arguments.length;
var i__7879__auto___10267 = (0);
while(true){
if((i__7879__auto___10267 < len__7878__auto___10266)){
args__7885__auto__.push((arguments[i__7879__auto___10267]));

var G__10268 = (i__7879__auto___10267 + (1));
i__7879__auto___10267 = G__10268;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__7886__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__10261_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__10262_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__10262_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq10263){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__10264,G__10265,seq10263__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1513114920065