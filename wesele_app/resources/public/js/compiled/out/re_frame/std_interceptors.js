...
var vec__37264_37267 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_37268 = cljs.core.nth.call(null,vec__37264_37267,(0),null);
var only_after_37269 = cljs.core.nth.call(null,vec__37264_37267,(1),null);
var db_changed_QMARK__37270 = (!((only_before_37268 == null))) || (!((only_after_37269 == null)));
if(db_changed_QMARK__37270){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_37268);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_37269);
...
var map__37277 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__37277__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__37277__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__37285 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__37285__$1;
var event = cljs.core.get.call(null,map__37285__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__34925__auto___37288 = arguments.length;
var i__34926__auto___37289 = (0);
while(true){
if((i__34926__auto___37289 < len__34925__auto___37288)){
args__34932__auto__.push((arguments[i__34926__auto___37289]));

var G__37290 = (i__34926__auto___37289 + (1));
i__34926__auto___37289 = G__37290;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__34933__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq37287){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq37287));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__33812__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__34932__auto__ = [];
var len__34925__auto___37296 = arguments.length;
var i__34926__auto___37297 = (0);
while(true){
if((i__34926__auto___37297 < len__34925__auto___37296)){
args__34932__auto__.push((arguments[i__34926__auto___37297]));

var G__37298 = (i__34926__auto___37297 + (1));
i__34926__auto___37297 = G__37298;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__34933__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__37291_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__37292_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__37292_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq37293){
var G__37294 = cljs.core.first.call(null,seq37293);
var seq37293__$1 = cljs.core.next.call(null,seq37293);
var G__37295 = cljs.core.first.call(null,seq37293__$1);
var seq37293__$2 = cljs.core.next.call(null,seq37293__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__37294,G__37295,seq37293__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1526470046406