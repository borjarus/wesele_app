...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__36821 = cljs.core.instance_QMARK_;
var expr__36822 = reactive_val;
if(cljs.core.truth_(pred__36821.call(null,reagent.ratom.RAtom,expr__36822))){
return "ra";
} else {
if(cljs.core.truth_(pred__36821.call(null,reagent.ratom.RCursor,expr__36822))){
return "rc";
} else {
if(cljs.core.truth_(pred__36821.call(null,reagent.ratom.Reaction,expr__36822))){
return "rx";
} else {
if(cljs.core.truth_(pred__36821.call(null,reagent.ratom.Track,expr__36822))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1526470039477