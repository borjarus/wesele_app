...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__9774 = cljs.core.instance_QMARK_;
var expr__9775 = reactive_val;
if(cljs.core.truth_(pred__9774.call(null,reagent.ratom.RAtom,expr__9775))){
return "ra";
} else {
if(cljs.core.truth_(pred__9774.call(null,reagent.ratom.RCursor,expr__9775))){
return "rc";
} else {
if(cljs.core.truth_(pred__9774.call(null,reagent.ratom.Reaction,expr__9775))){
return "rx";
} else {
if(cljs.core.truth_(pred__9774.call(null,reagent.ratom.Track,expr__9775))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1513114915236