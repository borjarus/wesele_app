...
var len__7878__auto___17818 = arguments.length;
var i__7879__auto___17819 = (0);
while(true){
if((i__7879__auto___17819 < len__7878__auto___17818)){
args__7885__auto__.push((arguments[i__7879__auto___17819]));

var G__17820 = (i__7879__auto___17819 + (1));
i__7879__auto___17819 = G__17820;
continue;
} else {
}
break;
...
return re_frisk.core.enable_re_frisk_BANG_.cljs$core$IFn$_invoke$arity$variadic(argseq__7886__auto__);
});
...
return cljs.core.merge.call(null,cljs.core.PersistentArrayMap.createAsIfByAssoc([new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__17810_SHARP_),(((cljs.core._EQ_.call(null,p2__17811_SHARP_,(0))) && (cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__17810_SHARP_),new cljs.core.Keyword(null,"coeffects","coeffects",497912985))))?new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(re_frisk.help.intrcp):(((cljs.core._EQ_.call(null,p2__17811_SHARP_,(1))) && (cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__17810_SHARP_),new cljs.core.Keyword(null,"do-fx","do-fx",1194163050))))?new cljs.core.Keyword(null,"do-fx","do-fx",1194163050).cljs$core$IFn$_invoke$arity$1(re_frisk.help.intrcp):((cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__17810_SHARP_),new cljs.core.Keyword(null,"db-handler","db-handler",579530098)))?new cljs.core.Keyword(null,"db-handler","db-handler",579530098).cljs$core$IFn$_invoke$arity$1(re_frisk.help.intrcp):((cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__17810_SHARP_),new cljs.core.Keyword(null,"fx-handler","fx-handler",-549783097)))?new cljs.core.Keyword(null,"fx-handler","fx-handler",-549783097).cljs$core$IFn$_invoke$arity$1(re_frisk.help.intrcp):"id"
))))]),(cljs.core.truth_(new cljs.core.Keyword(null,"before","before",-1633692388).cljs$core$IFn$_invoke$arity$1(p1__17810_SHARP_))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"before","before",-1633692388),(((cljs.core._EQ_.call(null,p2__17811_SHARP_,(0))) && (cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__17810_SHARP_),new cljs.core.Keyword(null,"coeffects","coeffects",497912985))))?new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(re_frisk.help.intrcp_fn):((cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__17810_SHARP_),new cljs.core.Keyword(null,"db-handler","db-handler",579530098)))?new cljs.core.Keyword(null,"db-handler","db-handler",579530098).cljs$core$IFn$_invoke$arity$1(re_frisk.help.intrcp_fn):((cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__17810_SHARP_),new cljs.core.Keyword(null,"fx-handler","fx-handler",-549783097)))?new cljs.core.Keyword(null,"fx-handler","fx-handler",-549783097).cljs$core$IFn$_invoke$arity$1(re_frisk.help.intrcp_fn):"fn"
)))], null):null),(cljs.core.truth_(new cljs.core.Keyword(null,"after","after",594996914).cljs$core$IFn$_invoke$arity$1(p1__17810_SHARP_))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"after","after",594996914),(((cljs.core._EQ_.call(null,p2__17811_SHARP_,(1))) && (cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__17810_SHARP_),new cljs.core.Keyword(null,"do-fx","do-fx",1194163050))))?new cljs.core.Keyword(null,"do-fx","do-fx",1194163050).cljs$core$IFn$_invoke$arity$1(re_frisk.help.intrcp_fn):"fn"
)], null):null));
});})(prefs))
...
return cljs.core.not_EQ_.call(null,cljs.core.key.call(null,p1__17812_SHARP_),new cljs.core.Keyword("re-frisk","update-db","re-frisk/update-db",-658524246));
});})(prefs))
...
var k = cljs.core.first.call(null,p1__17813_SHARP_);
...
return cljs.core.not_EQ_.call(null,cljs.core.first.call(null,p1__17814_SHARP_),new cljs.core.Keyword("re-frisk.core","db","re-frisk.core/db",447694709));
});})(prefs,event))
...
if(cljs.core.truth_(p1__17815_SHARP_.call(null,re_frisk.help.fx))){
return cljs.core.PersistentArrayMap.createAsIfByAssoc([p1__17815_SHARP_,p1__17815_SHARP_.call(null,re_frisk.help.fx)]);
} else {
...
if(cljs.core.truth_(p1__17816_SHARP_.call(null,re_frisk.help.cofx))){
return cljs.core.PersistentArrayMap.createAsIfByAssoc([p1__17816_SHARP_,p1__17816_SHARP_.call(null,re_frisk.help.cofx)]);
} else {
...
re_frisk.core.enable_re_frisk_BANG_.cljs$lang$applyTo = (function (seq17817){
return re_frisk.core.enable_re_frisk_BANG_.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq17817));
});

re_frisk.core.enable_frisk_BANG_ = (function re_frisk$core$enable_frisk_BANG_(var_args){
var args__7885__auto__ = [];
var len__7878__auto___17822 = arguments.length;
var i__7879__auto___17823 = (0);
while(true){
if((i__7879__auto___17823 < len__7878__auto___17822)){
args__7885__auto__.push((arguments[i__7879__auto___17823]));

var G__17824 = (i__7879__auto___17823 + (1));
i__7879__auto___17823 = G__17824;
continue;
} else {
}
break;
...
var argseq__7886__auto__ = ((((0) < args__7885__auto__.length))?(new cljs.core.IndexedSeq(args__7885__auto__.slice((0)),(0),null)):null);
return re_frisk.core.enable_frisk_BANG_.cljs$core$IFn$_invoke$arity$variadic(argseq__7886__auto__);
});
...
re_frisk.core.enable_frisk_BANG_.cljs$lang$applyTo = (function (seq17821){
return re_frisk.core.enable_frisk_BANG_.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq17821));
});
...
cljs.core.swap_BANG_.call(null,re_frisk.data.re_frame_data,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"views","views",1450155487),view,new cljs.core.Keyword(null,"subs","subs",-186681991)], null),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p1__17825_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([p1__17825_SHARP_],[re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__17825_SHARP_], null))]);
}),subs)));

var seq__17830 = cljs.core.seq.call(null,subs);
var chunk__17831 = null;
var count__17832 = (0);
var i__17833 = (0);
while(true){
if((i__17833 < count__17832)){
var s = cljs.core._nth.call(null,chunk__17831,i__17833);
...
var temp__4657__auto__ = cljs.core.seq.call(null,seq__17830);
if(temp__4657__auto__){
var seq__17830__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__17830__$1)){
var c__7584__auto__ = cljs.core.chunk_first.call(null,seq__17830__$1);
var G__17838 = cljs.core.chunk_rest.call(null,seq__17830__$1);
var G__17839 = c__7584__auto__;
var G__17840 = cljs.core.count.call(null,c__7584__auto__);
var G__17841 = (0);
seq__17830 = G__17838;
...
var s = cljs.core.first.call(null,seq__17830__$1);
cljs.core.swap_BANG_.call(null,re_frisk.data.re_frame_data,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"subs","subs",-186681991),s], null),re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [s], null)));
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("re-frisk","update-db","re-frisk/update-db",-658524246),(function (db,p__17846){
var vec__17847 = p__17846;
var _ = cljs.core.nth.call(null,vec__17847,(0),null);
var value = cljs.core.nth.call(null,vec__17847,(1),null);
return value;
}));

//# sourceMappingURL=core.js.map?rel=1513114956448