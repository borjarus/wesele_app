...
var len__34925__auto___45023 = arguments.length;
var i__34926__auto___45024 = (0);
while(true){
if((i__34926__auto___45024 < len__34925__auto___45023)){
args__34932__auto__.push((arguments[i__34926__auto___45024]));

var G__45025 = (i__34926__auto___45024 + (1));
i__34926__auto___45024 = G__45025;
continue;
} else {
}
break;
...
return re_frisk.core.enable_re_frisk_BANG_.cljs$core$IFn$_invoke$arity$variadic(argseq__34933__auto__);
});
...
return cljs.core.not_EQ_.call(null,cljs.core.key.call(null,p1__45017_SHARP_),new cljs.core.Keyword("re-frisk","update-db","re-frisk/update-db",-658524246));
});})(prefs))
...
var k = cljs.core.first.call(null,p1__45018_SHARP_);
...
return cljs.core.not_EQ_.call(null,cljs.core.first.call(null,p1__45019_SHARP_),new cljs.core.Keyword("re-frisk.core","db","re-frisk.core/db",447694709));
});})(prefs,event))
...
if(cljs.core.truth_(p1__45020_SHARP_.call(null,re_frisk.help.fx))){
return cljs.core.PersistentArrayMap.createAsIfByAssoc([p1__45020_SHARP_,p1__45020_SHARP_.call(null,re_frisk.help.fx)]);
} else {
return p1__45020_SHARP_;
}
});})(prefs,event,sub))
...
if(cljs.core.truth_(p1__45021_SHARP_.call(null,re_frisk.help.cofx))){
return cljs.core.PersistentArrayMap.createAsIfByAssoc([p1__45021_SHARP_,p1__45021_SHARP_.call(null,re_frisk.help.cofx)]);
} else {
...
re_frisk.core.enable_re_frisk_BANG_.cljs$lang$applyTo = (function (seq45022){
return re_frisk.core.enable_re_frisk_BANG_.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq45022));
});

re_frisk.core.enable_frisk_BANG_ = (function re_frisk$core$enable_frisk_BANG_(var_args){
var args__34932__auto__ = [];
var len__34925__auto___45027 = arguments.length;
var i__34926__auto___45028 = (0);
while(true){
if((i__34926__auto___45028 < len__34925__auto___45027)){
args__34932__auto__.push((arguments[i__34926__auto___45028]));

var G__45029 = (i__34926__auto___45028 + (1));
i__34926__auto___45028 = G__45029;
continue;
} else {
}
break;
...
var argseq__34933__auto__ = ((((0) < args__34932__auto__.length))?(new cljs.core.IndexedSeq(args__34932__auto__.slice((0)),(0),null)):null);
return re_frisk.core.enable_frisk_BANG_.cljs$core$IFn$_invoke$arity$variadic(argseq__34933__auto__);
});
...
re_frisk.core.enable_frisk_BANG_.cljs$lang$applyTo = (function (seq45026){
return re_frisk.core.enable_frisk_BANG_.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq45026));
});
...
cljs.core.swap_BANG_.call(null,re_frisk.data.re_frame_data,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"views","views",1450155487),view,new cljs.core.Keyword(null,"subs","subs",-186681991)], null),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p1__45030_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([p1__45030_SHARP_],[re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__45030_SHARP_], null))]);
}),subs)));

var seq__45035 = cljs.core.seq.call(null,subs);
var chunk__45036 = null;
var count__45037 = (0);
var i__45038 = (0);
while(true){
if((i__45038 < count__45037)){
var s = cljs.core._nth.call(null,chunk__45036,i__45038);
...
var G__45039 = seq__45035;
var G__45040 = chunk__45036;
var G__45041 = count__45037;
var G__45042 = (i__45038 + (1));
seq__45035 = G__45039;
chunk__45036 = G__45040;
count__45037 = G__45041;
i__45038 = G__45042;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__45035);
if(temp__4657__auto__){
var seq__45035__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__45035__$1)){
var c__34631__auto__ = cljs.core.chunk_first.call(null,seq__45035__$1);
var G__45043 = cljs.core.chunk_rest.call(null,seq__45035__$1);
var G__45044 = c__34631__auto__;
var G__45045 = cljs.core.count.call(null,c__34631__auto__);
var G__45046 = (0);
seq__45035 = G__45043;
chunk__45036 = G__45044;
count__45037 = G__45045;
i__45038 = G__45046;
continue;
} else {
var s = cljs.core.first.call(null,seq__45035__$1);
cljs.core.swap_BANG_.call(null,re_frisk.data.re_frame_data,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"subs","subs",-186681991),s], null),re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [s], null)));

var G__45047 = cljs.core.next.call(null,seq__45035__$1);
var G__45048 = null;
var G__45049 = (0);
var G__45050 = (0);
seq__45035 = G__45047;
chunk__45036 = G__45048;
count__45037 = G__45049;
i__45038 = G__45050;
continue;
}
} else {
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("re-frisk","update-db","re-frisk/update-db",-658524246),(function (db,p__45051){
var vec__45052 = p__45051;
var _ = cljs.core.nth.call(null,vec__45052,(0),null);
var value = cljs.core.nth.call(null,vec__45052,(1),null);
return value;
}));

//# sourceMappingURL=core.js.map?rel=1526470119672